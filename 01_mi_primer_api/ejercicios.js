...
para esto usaremos axios
*/
// hacemos una funcion para obtener el personaje
...
app.get('/api/swapi/:idCharacter', async (req, res) => {const { idCharacter } = req.params;
...
/*
Como refactorizar un endpoint para
trabajar con la arquitectura MVC?
(Modelo - Vista - Controlador)
*/
//tomando el ejercicio 4...

//Modelo se encarga de ir a la seccion de los datos los consume y se los da al controlador
const getCharacterFromSWAPI = async (idCharacter) => {
    const {data} = await axios.get(`https://swapi.dev/api/people/${idCharacter}/`);
    return data;
}
// Controlador quien controla que pasa al ejecutar el endpoint
